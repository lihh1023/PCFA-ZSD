...
import numpy as np
from keras_retinanet.models import MyLayer_w2v_seen as MyLayer_w2v
...
def default_classification_model(
    ...
    for i in range(4):
        outputs = keras.layers.Conv2D(
            ...
            kernel_initializer=keras.initializers.normal(mean=0.0, stddev=0.01, seed=5),
    ...
    attributes = keras.layers.Dense(units=128, activation='elu', kernel_regularizer=regularizers.l2(0.01))(attribute)   # attributes
    score = keras.layers.Lambda(Similarity.similarity)([feature, attributes]) # test
