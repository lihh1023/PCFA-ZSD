...
from ..preprocessing.csv_generator_attribute_unseen import CSVGenerator
from ..utils.keras_version import check_keras_version
from ..utils.eval_attribute_unseen import evaluate
...
def parse_args(args):
    ...
    parser.add_argument('--word-data-type', help='Word data type.', type=str, default='attribute_unseen')
...
def main(args=None):
    ...
    if args.word_data_type == 'attribute_unseen':
        word_number = 15
        word_shape = 79
    else:
        # word_data = None
    ...
    model = retinanet.retinanet_bbox(inputs=inputs, num_classes=15, attribute_shape=word_data_shape, backbone=resnet)
    ...
    print('UnSeen mAP: {:.4f} Unseen Rec: {:.4f}'.format(unseenMAP, unseenRE))
