...
from ..preprocessing.csv_generator_attribute import CSVGenerator
from ..utils.keras_version import check_keras_version
from ..utils.eval_attribute import evaluate
...
def parse_args(args):
    ...
    parser.add_argument('--word-data-type', help='Word data type.', type=str, default='attribute_all')
...
def main(args=None):
    ...
    if args.word_data_type == 'attribute_all':
        word_number = 80
        word_shape = 79
    else:
        # word_data = None
